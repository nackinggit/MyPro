	...
	private static final class MyRunnable implements Runnable {
		...
		public void run() {
			...
			try {
				...
				MyRequestObj requestObj = new MyRequestObj("request_" + index, "request_" + index);
		...
		private void sendData(SocketChannel socketChannel, MyRequestObj requestObj) throws IOException {
		...
		private MyResponseObj receiveData(SocketChannel socketChannel) throws IOException {
