...
public class Server {
	...
	private static void execute(ServerSocketChannel channel) throws IOException {
		...
		try {
			...
			MyResponseObj responseObj = new MyResponseObj("response for "
					+ requestObj.getName(), "response for "
					+ requestObj.getValue());
	...
	private static MyRequestObj recieveData(SocketChannel socketChannel)
			throws IOException {
	...
	private static void sendData(SocketChannel socketChannel,
			MyResponseObj responseObj) throws IOException {
